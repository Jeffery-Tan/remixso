// 品牌 SVG 图标 —— 各平台真实 logo
// 用于 PlatformPicker、首页、Dashboard 等展示平台的地方
...
export function PlatformIcon({ platform, size = 20, className }: PlatformIconProps) {
  const cls = className ?? "text-[var(--on-surface-variant)] group-hover:scale-110 transition-transform duration-300";
